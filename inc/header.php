    ...
    <div class="row">
      ...
      <nav class="container-fluid navbar">
          <div class="col-lg-2 col-md-2">
            <h1 class="logo"> <strong>Solve Engenharia</strong>
             <a href="https://solveengenharia.com.br/" title="Solve Engenharia" class="logo"> 
             <img src="images/logo-solve-engenharia-santa-maria.png" alt="Solve Engenharia"> </a> </h1>
